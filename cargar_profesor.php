...
if (isset($_POST["cedula"])){
 ...
 if (isset($_POST["profesor"])) {
    $alumno=$_POST["profesor"];
}
     if (isset($_POST["cod_candidato"])) {
    $cod_candidato=$_POST["cod_candidato"];
}
     if (isset($_POST["cedula_profesor"])) {
    $alu=$_POST["cedula_profesor"];
}
...
if (isset($_POST["boton"])) {
	...
	?>
		...
		$sql="insert into profesores (cedula_profesor,nombre,carrera,cod_candidato,voto) values ('$cedula','$nombre','$municipio','0','0') ";
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <h1 class="text-center">Modulo de  registro de profesores</h1>
    </div>
  </div>
  <hr>
</div>
<div class="container">
 <div class="center-block col-md-4 col-xs-8">
		<td><?php echo "<font size='5' color='blue'>Bienvenido:</font>"."<font size='5' color='red'>".$_SESSION["nombre"]."</font>";
				...
				?></td>
<form name ="acceso" action="cargar_profesor.php" role="form" method="post">
